#+TITLE: Miryoku Babel [[https://raw.githubusercontent.com/manna-harbour/miryoku/master/data/logos/miryoku-roa-32.png]]
#+STARTUP: overview

[[https://raw.githubusercontent.com/manna-harbour/miryoku/master/data/cover/miryoku-kle-cover-miryoku_babel.png]]

This document describes Miryoku Babel only.
...
- [[https://github.com/manna-harbour/miryoku_babel][Miryoku Babel]] generates the layer data source files for Miryoku implementations from a single source.

[[#layer-tables][Layers]] and [[#alternative-layouts][alternative layouts]] are maintained in org tables.
The tables are [[#tangling][tangled]] into [[#tangled-files][source files]] via [[#scripts-and-data][python scripts and additional data tables]].
...
- [[#scripts-and-data][Scripts and data]]
  - [[#common][Common]]
  - [[#miryoku-qmk][Miryoku QMK]]
  - [[#miryoku-zmk][Miryoku ZMK]]
  - [[#miryoku-svg][Miryoku SVG]]
  - [[#miryoku-kmk][Miryoku KMK]]
- [[#tangled-files][Tangled files]]
  - [[#miryoku-qmk-1][Miryoku QMK]]
  - [[#miryoku-zmk-1][Miryoku ZMK]]
  - [[#miryoku-kmonad][Miryoku KMonad]]
  - [[#miryoku-svg-1][Miryoku SVG]]
  - [[#miryoku-kmk-1][Miryoku KMK]]
#+END_QUOTE
...
To tangle from within emacs, call ~org-babel-tangle~ (~C-c~ ~C-v~ ~t~).

For other options, see the Install Org and Tangle steps in [[.github/workflows/main.yml]] for example shell commands that can be run locally.

** GitHub Actions Workflow

Make sure workflows are enabled for this GitHub repository.
...
4. Select the branch if desired
5. Activate =Run workflow=
6. Select =Artifacts= and unzip the downloaded zip file.
